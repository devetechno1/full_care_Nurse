...
ThemeData dark = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF61A4C3))),
  colorScheme: const ColorScheme.dark(primary: const Color(0xFF1e81b0), secondary: const Color(0xFF61A4C3)).copyWith(error: const Color(0xFFdd3135)),
